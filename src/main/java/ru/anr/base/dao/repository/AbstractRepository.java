...
/**
 * An abstract repository supports arbitrary objects, not only
 * {@link ru.anr.base.domain.BaseEntity}.
 *
...
public interface AbstractRepository<T> extends JpaRepository<T, Long>, JpaSpecificationExecutor<T> {
    ...
    /**
     * Returns the entity manager for doing non-standard operations
     *
